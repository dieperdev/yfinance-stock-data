### Note: This repo is similar to the one listed [here](https://github.com/dieperdev/nasdaq-stock-data) with the exception that the data comes from Yahoo Finance and has a longer history.
# Yahoo Finance Data
